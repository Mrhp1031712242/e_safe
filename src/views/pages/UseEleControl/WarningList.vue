<template>
  <main-content class="warning_list">
    <div class="top_search_wrap">
      <!-- <TreeSelect  propTreeSelId="timeSavingStat" :modelValue="areaIdVal"  size="default" class="ipt_tree_sel" style="width:150px;"/> -->
      <dict-select class="ipt_words" listUrl="/api/rbac/keyValue/selectList/alarmType" size="default" v-model="filter.alarmType" style="width:120px;margin-left:10px;" placeholder="告警类型"></dict-select>
    ...
    <div class="table_list_part">
      <table-list ref="listTable" :fetch="fetch" :filter="filter">
        ...
        <table-column prop="alarmName" label="告警名称" />
